...
class Player(commands.Cog):
    ...
    sphere: str = nextcord.SlashOption(name="sphere",description="Filtre sur la Sphère (Commandement,Connaissance,Energie,Tactique,Neutre...)",required=False,choices=["Pas de filtre (par défaut)","Commandement","Tactique","Energie","Connaissance","Neutre","Sacquet","Communauté"]),
